    ...
    <Shell>
      <div className="mx-auto grid min-h-screen max-w-7xl gap-10 px-6 py-10 lg:grid-cols-[0.95fr_1.05fr] lg:px-10 lg:py-14">
        <div className="rounded-[36px] bg-ink p-8 text-white lg:p-10">
          ...
          <h1 className="font-display mt-6 text-4xl font-semibold tracking-[-0.04em]">Masuk ke Taptu tanpa membuang langkah penting.</h1>
          ...
          <div className="mt-8 rounded-[28px] border border-white/10 bg-white/[0.06] p-5">
            ...
            <ul className="mt-4 space-y-3 text-sm text-[#d2e3dc]">
              <li>Admin: admin@taptu.app / Taptu123!</li>
              <li>Karyawan: employee@taptu.app / Taptu123!</li>
              <li>Scanner: scanner@taptu.app / Taptu123!</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex items-center">
          <form onSubmit={handleSubmit} className="w-full rounded-[36px] border border-[#dde6dd] bg-white p-7 shadow-panel md:p-10">
            <div>
              ...
              <h2 className="font-display mt-4 text-3xl font-semibold tracking-[-0.03em] text-ink">Akses workspace Taptu</h2>
